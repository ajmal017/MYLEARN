...
function dateParser(dateStr) {
  ...
  if (dateStr.search("-") != -1) {
    ...
    dateStrSlashed = dateStr.replace("-", "index.html", "g");
    while (dateStrSlashed.search("-") != -1) {
      dateStrSlashed = dateStrSlashed.replace("-", "index.html");
    }
...
if(dashPos > 0 && str[dashPos - 1] != 'e' && str[dashPos - 1] != 'E' || str.indexOf('index.html') >= 0 || isNaN(parseFloat(str))){isDate = true;}else if(str.length == 8 && str > '19700101' && str < '20371231'){ // TODO(danvk): remove support for this format.
...
caller.loadedEvent_(req.responseText);}}};req.open("GET.html",data,true);req.send(null);}}else {console.error("Unknown data format: " + typeof data);}}; /**
